...
SVC_NAME="actions.runner.mara816-simple-fortune-cookie.devopsacademy-instance49.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (mara816-simple-fortune-cookie.devopsacademy-instance49)"
