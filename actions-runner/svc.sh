...
SVC_NAME="actions.runner.miki2670-simple-fortune-cookie.devopsacademy-instance43.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (miki2670-simple-fortune-cookie.devopsacademy-instance43)"
